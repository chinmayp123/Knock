    ...
    public class RemoteFetch {
        ...
        private static final String OPEN_WEATHER_MAP_URL = "http://api.openweathermap.org/data/2.5/weather?lat=%s&lon=%s&units=imperial";

        private static final String OPEN_WEATHER_MAP_API = "eb63fb2e1423b2372e00d9b9c0f3485e";

        public static String city=null, temperature = null, description = null;
