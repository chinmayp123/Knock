...
public class detectKnock implements SensorEventListener{
    ...
    public static void readWeather(){
        String info;
        String city = RemoteFetch.getCity();
        String desc = RemoteFetch.getDescription();
        String temp = RemoteFetch.getTemperature();
        info = "In " + city + " it is " + desc + " and currently it is " + temp + "degrees Fahrenheit";
        t2.speak(info, TextToSpeech.QUEUE_FLUSH,null);
    }
